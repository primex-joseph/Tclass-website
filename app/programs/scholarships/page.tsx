...
export default function ScholarshipsPage() {
  const qualifications = [
    ...
    "For ICT scholarship track: Must meet interview requirements",
  ];
  ...
  const documentaryRequirements = [
    ...
    "For ICT scholarship track: Valid ID/Recent School ID, SF9/Report Card, and Certificate of Good Moral Conduct",
  ];
  ...
  return (
    <main className="relative min-h-screen text-slate-900">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl font-bold text-blue-950">Scholarships</h1>
        <p className="mt-6 text-xl text-slate-800 leading-relaxed">
          TCLASS supports learners through scholarship opportunities, including government and partner-funded
          training assistance for eligible applicants.
        </p>
        <ul className="mt-8 list-disc pl-6 text-lg text-slate-800 space-y-2">
          <li>Application screening and qualification process</li>
          <li>Priority tracks for high-demand skills programs</li>
          <li>Enrollment support for accepted scholars</li>
        </ul>
