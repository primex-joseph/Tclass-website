  ...
  return (
    <main className="relative min-h-screen text-slate-900">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl font-bold text-blue-950">Housekeeping Program</h1>
        <p className="mt-6 text-xl text-slate-800 leading-relaxed">
          The Housekeeping NCII track trains learners in hospitality standards, cleaning systems,
          room preparation, and service professionalism.
        </p>
        <ul className="mt-8 list-disc pl-6 text-lg text-slate-800 space-y-2">
          <li>Guest room and facility upkeep procedures</li>
          <li>Hospitality service etiquette</li>
          <li>Quality control and safety protocols</li>
        </ul>
