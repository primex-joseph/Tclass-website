  ...
  return (
    <main className="relative min-h-screen text-slate-900">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl font-bold text-blue-950">Health Care Services Program</h1>
        <p className="mt-6 text-xl text-slate-800 leading-relaxed">
          The Health Care Services NCII track provides practical competencies for entry-level support roles in
          health-related settings and community care environments.
        </p>
        <ul className="mt-8 list-disc pl-6 text-lg text-slate-800 space-y-2">
          <li>Basic patient support procedures</li>
          <li>Health and hygiene standards</li>
          <li>Workplace communication and documentation</li>
        </ul>
